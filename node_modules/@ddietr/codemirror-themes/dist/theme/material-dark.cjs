...
const materialDarkTheme = view.EditorView.theme({
    '&': {
...
const materialDarkHighlightStyle = language.HighlightStyle.define([
...
const materialDark = [
    materialDarkTheme,
    language.syntaxHighlighting(materialDarkHighlightStyle),
];

exports.config = config;
exports.materialDark = materialDark;
exports.materialDarkHighlightStyle = materialDarkHighlightStyle;
exports.materialDarkTheme = materialDarkTheme;
